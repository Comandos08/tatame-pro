/**
 * T1.0 — EVENTS RUNTIME RESILIENCE TESTS (SAFE GOLD v1.0)
 *
...
test.describe('T1.0 — EVENTS RUNTIME RESILIENCE (SAFE GOLD)', () => {
  ...
  test('E.R.5: no redirect under any events failure', async ({ page }) => {
