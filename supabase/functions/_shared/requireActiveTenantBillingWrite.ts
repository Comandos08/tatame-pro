 ...
 * 
 * This is a READ-ONLY gate — does not modify any data.
 */
...
export async function requireActiveTenantBillingWrite(
  ...
  try {
    console.log(`[requireActiveTenantBillingWrite] Checking ${operation} for tenant:`, tenantId);
    ...
    // ========================================================================
    console.log(`[requireActiveTenantBillingWrite] ${operation} allowed for tenant:`, tenantId);
    return {
      ok: true,
      tenantStatus: tenant.status,
      billingStatus: status,
