export const ptBR = {
  ...
  'membership.expectation.title': 'Próximo passo após o pagamento',
  'membership.expectation.body': 'Seu pagamento será confirmado imediatamente.\nA aprovação da filiação ocorre em até 24 horas úteis.\nVocê poderá acompanhar o status em tempo real.',
  'membership.expectation.security': 'Pagamento seguro via Stripe. Nenhuma cobrança adicional será realizada sem sua autorização.',
  'membership.selector.reassurance': 'Processo simples em poucas etapas. Pagamento imediato, aprovação rápida.',
  ...
  'membershipSuccess.paymentConfirmed': 'Pagamento Confirmado',
   'membershipSuccess.oops': 'Erro na confirmação',
   'membershipSuccess.pendingConfirmationTitle': 'Confirmação pendente',
   'membershipSuccess.confirmPending': 'Seu pagamento foi recebido. Estamos verificando.',
   'membershipSuccess.successMessage': 'Sua inscrição foi registrada e está em análise.',
   'membershipSuccess.invalidParams': 'Não foi possível confirmar automaticamente seu pagamento.',
   'membershipSuccess.confirmError': 'Seu pagamento foi recebido. Estamos verificando.',
   'membershipSuccess.processError': 'Seu pagamento foi recebido. Estamos verificando.',
  'membershipSuccess.membershipStatus': 'Status da Inscrição',
  'membershipSuccess.pendingApproval': 'Em Análise',
  'membershipSuccess.pendingApprovalDesc': 'Nosso time está validando seus dados. Você receberá uma notificação quando sua inscrição for aprovada.',
  'membershipSuccess.approvedTitle': 'Inscrição Aprovada',
  'membershipSuccess.approvedSubtitle': 'Seu acesso já está ativo.',
  'membershipSuccess.approvedCta': 'Acessar Portal do Atleta',
  'membershipSuccess.backTo': 'Voltar para {tenant}',
  'membershipSuccess.tryAgain': 'Tentar novamente',
  'membershipSuccess.viewStatus': 'Ver status da inscrição',
  'membershipSuccess.retryConfirmation': 'Revalidar pagamento',
  'membershipSuccess.timeline.payment': 'Pagamento realizado',
  'membershipSuccess.timeline.validation': 'Validação da inscrição',
  'membershipSuccess.timeline.card': 'Emissão do cartão digital',
  ...
  'memberships.myMemberships': 'Minhas Filiações',
  'memberships.trackStatus': 'Acompanhe o status das suas filiações na',
  'memberships.newMembership': 'Nova Filiação',
  'memberships.loadError': 'Erro ao carregar filiações',
  'memberships.start': 'Início',
  'memberships.validity': 'Validade',
  'memberships.card': 'Carteira',
  'memberships.backToList': 'Voltar para filiações',
  'memberships.notFound': 'Filiação não encontrada',
  'memberships.value': 'Valor',
  'memberships.academy': 'Academia',
  'memberships.athleteData': 'Dados do Atleta',
  'memberships.fullName': 'Nome completo',
  'memberships.digitalCard': 'Carteira Digital',
  'memberships.downloadPdf': 'Baixar PDF da Carteira',
  'memberships.manageGradings': 'Gerenciar Graduações',
  'memberships.gradingHistory': 'Histórico de faixas e promoções',
  ...
  'events.backToEvent': 'Voltar para o evento',
  'events.until': 'até',
  'events.brackets': 'Chaves',
  'events.viewBrackets': 'Ver chaves do torneio',
  'events.noBracketsPublished': 'Chaves ainda não divulgadas',
  'events.noBracketsPublishedDesc': 'As chaves serão disponibilizadas assim que a organização publicá-las.',
  ...
  'roles.management': 'Gerenciar Papéis',
  'roles.grantRole': 'Conceder Papel',
  'roles.revokeRole': 'Revogar Papel',
  'roles.granted': 'Papel concedido com sucesso',
  'roles.revoked': 'Papel revogado com sucesso',
  'roles.grantError': 'Erro ao conceder papel',
  'roles.revokeError': 'Erro ao revogar papel',
  'roles.confirmRevoke': 'Confirmar remoção de papel?',
  'roles.confirmRevokeDesc': 'Isso removerá o papel selecionado do usuário.',
  'roles.cannotRemoveLast': 'Não é possível remover o último papel. O usuário ficaria sem acesso.',
  'roles.forceRemoveAll': 'Forçar remoção de todos os papéis',
  'roles.forceRemoveWarning': 'Isso encerrará a participação do usuário nesta organização.',
  ...
  'auth.magicLink.invalidTenant': 'Organização não encontrada ou inativa.',
  ...
  'impersonation.scopeMismatch': 'Escopo de impersonation incompatível',
  'impersonation.scopeMismatchDesc': 'A sessão de impersonation ativa é para um tenant diferente do que você está tentando acessar.',
  'impersonation.scopeMismatchHint': 'Encerre a sessão atual e inicie uma nova para o tenant correto.',
  ...
  'onboarding.checklist.title': 'Checklist de Ativação',
  'onboarding.checklist.subtitle': 'Complete todos os itens para ativar sua organização',
  'onboarding.checklist.statusDone': 'Concluído',
  'onboarding.checklist.statusPending': 'Pendente',
  'onboarding.checklist.statusLocked': 'Bloqueado',
  'onboarding.checklist.tenantCreated': 'Organização criada',
  'onboarding.checklist.tenantCreatedDesc': 'Sua organização foi registrada e está ativa.',
  'onboarding.checklist.roleAssigned': 'Papel atribuído',
  'onboarding.checklist.roleAssignedDesc': 'Seu papel administrativo foi configurado.',
  'onboarding.checklist.membershipConfigured': 'Filiação configurada',
  'onboarding.checklist.membershipConfiguredDesc': 'Pelo menos uma filiação foi criada.',
  'onboarding.checklist.firstMemberApproved': 'Primeiro membro aprovado',
  'onboarding.checklist.firstMemberApprovedDesc': 'Pelo menos um membro foi aprovado.',
  'onboarding.checklist.billingActive': 'Faturamento ativo',
  'onboarding.checklist.billingActiveDesc': 'O faturamento foi configurado e está ativo.',
  'onboarding.checklist.securityOk': 'Segurança OK',
  'onboarding.checklist.securityOkDesc': 'A postura de segurança está saudável.',
  // Security Timeline
  ...
  // Cookie Consent
  'cookie.message': 'Este site utiliza cookies essenciais para funcionamento e cookies analíticos para melhorar sua experiência.',
  ...
  'privacy.controller.title': '1. Controlador de Dados',
  'privacy.controller.text': 'O Tatame Pro atua como plataforma de gestão esportiva. Cada federação, liga ou organização que utiliza o sistema é a controladora dos dados de seus atletas e membros, conforme a Lei Geral de Proteção de Dados (LGPD — Lei 13.709/2018).',
  'privacy.dataCollected.title': '2. Dados Coletados',
  'privacy.dataCollected.text': 'Coletamos os seguintes dados pessoais:\n- Nome completo, data de nascimento, CPF\n- E-mail e telefone de contato\n- Dados de filiação esportiva (graduação, academia, federação)\n- Dados de pagamento (processados via Stripe — não armazenamos dados de cartão)\n- Dados de responsável legal (para menores de 18 anos)',
  'privacy.purpose.title': '3. Finalidade do Tratamento',
  'privacy.purpose.text': 'Os dados são tratados para:\n- Gestão de filiações e eventos esportivos\n- Emissão de documentos (carteirinhas, diplomas)\n- Processamento de pagamentos\n- Comunicações relacionadas à organização esportiva\n- Cumprimento de obrigações legais',
  'privacy.legalBasis.title': '4. Base Legal (LGPD)',
  'privacy.legalBasis.text': 'O tratamento de dados é fundamentado em:\n- Execução de contrato (Art. 7º, V) — filiação esportiva\n- Consentimento (Art. 7º, I) — dados opcionais e comunicações\n- Obrigação legal (Art. 7º, II) — dados fiscais e regulatórios\n- Proteção do menor (Art. 14º) — consentimento do responsável legal',
  'privacy.sharing.title': '5. Compartilhamento de Dados',
  'privacy.sharing.text': 'Seus dados podem ser compartilhados com:\n- A federação/liga/organização à qual você é filiado\n- Processadores de pagamento (Stripe) para transações financeiras\n- Serviços de infraestrutura (Supabase) para armazenamento seguro\n- Autoridades competentes quando exigido por lei',
  'privacy.rights.title': '6. Seus Direitos (LGPD Art. 18)',
  'privacy.rights.text': 'Você tem direito a:\n- Confirmar a existência de tratamento de dados\n- Acessar seus dados pessoais\n- Corrigir dados incompletos ou desatualizados\n- Solicitar anonimização ou eliminação de dados desnecessários\n- Solicitar portabilidade dos dados\n- Revogar consentimento a qualquer momento\n\nPara exercer seus direitos, acesse a seção "Privacidade e Dados" no portal do atleta ou entre em contato com sua organização esportiva.',
  'privacy.cookies.title': '7. Cookies',
  'privacy.cookies.text': 'Utilizamos cookies para:\n- Cookies essenciais: autenticação, sessão e preferências de idioma\n- Cookies analíticos: monitoramento de erros (Sentry) para melhoria do serviço\n\nVocê pode gerenciar suas preferências de cookies a qualquer momento.',
  'privacy.retention.title': '8. Retenção de Dados',
  'privacy.retention.text': 'Os dados pessoais são mantidos enquanto a filiação estiver ativa. Após solicitação de exclusão, os dados são removidos em até 30 dias, exceto quando houver obrigação legal de retenção.',
  'privacy.contact.title': '9. Contato',
  ...
  'terms.acceptance.text': 'Ao acessar ou utilizar o Tatame Pro (a "Plataforma"), você declara ter lido, compreendido e concordado integralmente com estes Termos de Uso e com a Política de Privacidade. Caso não concorde com qualquer dispositivo, deve interromper imediatamente o uso da Plataforma.',
  'terms.service.title': '2. Descrição do Serviço',
  'terms.service.text': 'O Tatame Pro é uma plataforma SaaS multi-tenant de gestão para federações, ligas, academias e organizações esportivas de artes marciais. Oferece recursos de cadastro de atletas, controle de filiações, emissão de carteirinhas digitais e diplomas, gestão de eventos, brackets, rankings, processamento de pagamentos via Stripe e trilhas de auditoria.',
  'terms.account.title': '3. Cadastro e Conta',
  'terms.account.text': 'Para utilizar a Plataforma você deve:\n- Ser maior de 18 anos ou ter consentimento expresso do responsável legal\n- Fornecer informações verdadeiras, completas e atualizadas\n- Manter a confidencialidade de suas credenciais de acesso\n- Notificar imediatamente qualquer uso não autorizado de sua conta\n\nVocê é o único responsável por todas as atividades realizadas em sua conta.',
  'terms.acceptableUse.title': '4. Uso Aceitável',
  'terms.acceptableUse.text': 'Você concorda em NÃO utilizar a Plataforma para:\n- Praticar qualquer atividade ilícita ou em desacordo com a legislação brasileira\n- Violar direitos de terceiros, incluindo propriedade intelectual\n- Inserir dados falsos, enganosos ou difamatórios\n- Tentar acessar áreas restritas, sistemas de terceiros ou dados de outros tenants\n- Realizar engenharia reversa, scraping massivo ou ataques de qualquer natureza\n- Sobrecarregar a infraestrutura ou interferir no funcionamento normal do serviço',
  'terms.payments.title': '5. Pagamentos e Assinaturas',
  'terms.payments.text': 'Os pagamentos são processados exclusivamente pela Stripe, em conformidade com a PCI-DSS. O Tatame Pro não armazena dados de cartão de crédito. As assinaturas são renovadas automaticamente conforme o plano contratado e podem ser canceladas a qualquer momento pelo portal do cliente, surtindo efeito ao final do ciclo de cobrança vigente. Os preços podem ser reajustados anualmente mediante comunicação prévia de 30 dias.',
  'terms.marketplace.title': '6. Marketplace e Repasses',
  'terms.marketplace.text': 'O Tatame Pro opera como facilitador de pagamentos (marketplace) por meio do Stripe Connect. As taxas de filiação e inscrições em eventos pertencem à organização esportiva (Tenant), não ao Tatame Pro. Quando a organização conclui o cadastro no Stripe Connect, os valores são processados pelo Stripe e repassados diretamente à conta conectada da organização, sendo retida automaticamente apenas a taxa de plataforma divulgada (percentual sobre cada transação). O Tatame Pro não detém, custodia nem administra os recursos dos atletas além da sua taxa. Os repasses para a conta bancária da organização seguem o calendário e as regras do Stripe. Cada organização é responsável por suas obrigações fiscais e tributárias sobre os valores recebidos. Enquanto a organização não concluir o cadastro no Stripe Connect, novos pagamentos poderão ser temporariamente retidos até a regularização.',
  'terms.refunds.title': '7. Reembolsos',
  'terms.refunds.text': 'Em conformidade com o Código de Defesa do Consumidor (Art. 49), o usuário pessoa física tem direito ao arrependimento em até 7 (sete) dias corridos contados da contratação, com reembolso integral. Após esse prazo, reembolsos serão analisados caso a caso, considerando o uso efetivo da Plataforma. Taxas de filiação esportiva pagas a organizações terceiras seguem a política da própria organização.',
  'terms.intellectualProperty.title': '8. Propriedade Intelectual',
  'terms.intellectualProperty.text': 'Todo o conteúdo, marca, código-fonte, design, layout e funcionalidades da Plataforma são de propriedade exclusiva do Tatame Pro ou de seus licenciadores, protegidos pelas leis de propriedade intelectual. É concedida ao usuário uma licença limitada, não-exclusiva e revogável de uso, restrita à finalidade contratada.',
  'terms.tenantData.title': '9. Dados do Tenant e Multi-tenancy',
  'terms.tenantData.text': 'Cada federação, liga ou academia ("Tenant") é a controladora dos dados de seus filiados, nos termos da LGPD. O Tatame Pro atua como operador, garantindo isolamento técnico entre tenants por meio de Row Level Security no banco de dados. O Tenant é responsável por:\n- Obter as bases legais necessárias para o tratamento de dados de seus filiados\n- Cumprir as solicitações de titulares de dados\n- Manter contrato de DPA (Data Processing Agreement) quando aplicável',
  'terms.availability.title': '10. Disponibilidade do Serviço',
  'terms.availability.text': 'O Tatame Pro busca manter SLA de 99,5% de disponibilidade mensal, conforme descrito em nossa política de SLA. Não há garantia de operação ininterrupta — interrupções programadas serão comunicadas com antecedência sempre que possível. Manutenções emergenciais podem ocorrer sem aviso prévio.',
  'terms.liability.title': '11. Limitação de Responsabilidade',
  'terms.liability.text': 'O Tatame Pro não se responsabiliza por:\n- Conteúdo, decisões ou atos praticados pelos Tenants ou seus filiados\n- Disputas entre Tenants e seus filiados\n- Perdas decorrentes de uso indevido das credenciais por terceiros\n- Indisponibilidade temporária de serviços de infraestrutura terceiros (Supabase, Stripe, Resend, Cloudflare)\n\nNos limites permitidos pela legislação, a responsabilidade do Tatame Pro fica limitada ao valor efetivamente pago pelo usuário nos 12 (doze) meses anteriores ao evento que originar a demanda.',
  'terms.termination.title': '12. Suspensão e Encerramento',
  'terms.termination.text': 'O Tatame Pro reserva-se o direito de suspender ou encerrar contas que violem estes Termos, mediante notificação prévia quando possível. Em caso de violação grave (fraude, uso ilícito, ataques), a suspensão pode ser imediata. Após o encerramento, os dados serão retidos pelo prazo legal mínimo e posteriormente eliminados conforme a Política de Retenção de Dados.',
  'terms.changes.title': '13. Alterações dos Termos',
  'terms.changes.text': 'Estes Termos podem ser atualizados periodicamente. Alterações materiais serão comunicadas por e-mail e/ou aviso destacado na Plataforma com antecedência mínima de 15 dias. A continuidade do uso após a vigência das alterações constitui aceitação tácita.',
  'terms.law.title': '14. Legislação Aplicável e Foro',
  'terms.law.text': 'Estes Termos são regidos pelas leis da República Federativa do Brasil. Fica eleito o foro da comarca da sede do Tatame Pro para dirimir quaisquer controvérsias decorrentes, com renúncia a qualquer outro, por mais privilegiado que seja.',
  'terms.contact.title': '15. Contato',
  'terms.contact.text': 'Dúvidas, solicitações ou notificações relacionadas a estes Termos podem ser direcionadas ao canal de suporte da Plataforma ou à organização esportiva à qual você é filiado.',
  'terms.relatedPrivacy': 'Consulte também nossa',
  'terms.relatedPrivacyLink': 'Política de Privacidade',
  'terms.lastUpdated': 'Última atualização: Maio de 2026',

  // Footer / shared legal links
  'footer.privacy': 'Privacidade',
  'footer.terms': 'Termos de Uso',
  'checkout.legal.consent': 'Ao prosseguir, você concorda com nossos',
  'checkout.legal.and': 'e',

  // Stripe Connect — marketplace payouts (settings + banners)
  'connect.title': 'Repasses e conta bancária',
  'connect.description': 'Conecte sua conta para receber as filiações e inscrições diretamente. A plataforma retém {fee}% por transação; o restante vai para sua conta automaticamente.',
  'connect.connect': 'Conectar conta bancária',
  'connect.continue': 'Continuar configuração',
  'connect.refresh': 'Atualizar status',
  'connect.refreshed': 'Status atualizado.',
  'connect.openDashboard': 'Abrir painel de repasses',
  'connect.status.active': 'Conta ativa',
  'connect.status.payoutsOn': 'Repasses para o seu banco estão habilitados.',
  'connect.status.payoutsPending': 'Recebendo pagamentos. Os repasses para o banco serão liberados após a verificação da Stripe.',
  'connect.status.underReview': 'Em análise pela Stripe',
  'connect.status.underReviewDesc': 'Você concluiu o cadastro. A Stripe está verificando os dados — isso costuma levar alguns minutos.',
  'connect.status.incomplete': 'Cadastro iniciado mas não concluído. Continue para poder receber pagamentos.',
  'connect.status.notConnected': 'Você ainda não conectou uma conta bancária. Até conectar, os pagamentos não chegam até você.',
  'connect.error.start': 'Não foi possível iniciar a conexão. Tente novamente.',
  'connect.error.redirect': 'Não foi possível abrir a página de cadastro da Stripe.',
  'connect.error.dashboard': 'Não foi possível abrir o painel de repasses.',
  'connect.banner.notConnected': 'Sua organização ainda não conectou uma conta bancária — os pagamentos ficarão retidos na plataforma até você conectar.',
  'connect.banner.incomplete': 'O cadastro da sua conta bancária não foi concluído — os pagamentos ficarão retidos até finalizar.',
  'connect.banner.cta': 'Configurar repasses',
