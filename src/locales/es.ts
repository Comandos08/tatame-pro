export const es: Record<string, string> = {
  // Navigation
  'nav.onboarding': 'Configurar Organización',
  ...
  // Manifesto — PI U19
  'manifesto.title': 'Sistema estable y bajo control',
  'manifesto.message': 'Este ambiente opera con integridad, gobernanza y trazabilidad. La plataforma está saludable, los accesos son legítimos y las reglas se respetan.',
  ...
  'membership.expectation.title': 'Qué ocurre después del pago',
  'membership.expectation.body': 'Su pago será confirmado inmediatamente.\nLa aprobación de la afiliación ocurre en hasta 24 horas hábiles.\nPodrá seguir el estado en tiempo real.',
  'membership.expectation.security': 'Pago seguro vía Stripe. No se realizarán cargos adicionales sin su autorización.',
  'membership.selector.reassurance': 'Proceso simple en pocos pasos. Pago inmediato, aprobación rápida.',
  ...
  'membershipSuccess.paymentConfirmed': 'Pago Confirmado',
   'membershipSuccess.oops': 'Error en la confirmación',
   'membershipSuccess.pendingConfirmationTitle': 'Confirmación pendiente',
   'membershipSuccess.confirmPending': 'Su pago fue recibido. Estamos verificando.',
   'membershipSuccess.successMessage': 'Su inscripción ha sido registrada y está en revisión.',
   'membershipSuccess.invalidParams': 'No fue posible confirmar automáticamente su pago.',
  'membershipSuccess.confirmError': 'Su pago fue recibido. Estamos verificando.',
  'membershipSuccess.processError': 'Su pago fue recibido. Estamos verificando.',
  ...
  'membershipSuccess.retryConfirmation': 'Revalidar pago',
  ...
  // MembershipList + MembershipDetails page strings
  'memberships.myMemberships': 'Mis Afiliaciones',
  'memberships.trackStatus': 'Sigue el estado de tus afiliaciones en',
  'memberships.newMembership': 'Nueva Afiliación',
  'memberships.loadError': 'Error al cargar afiliaciones',
  'memberships.start': 'Inicio',
  'memberships.validity': 'Válido hasta',
  'memberships.card': 'Carnet',
  'memberships.backToList': 'Volver a afiliaciones',
  'memberships.notFound': 'Afiliación no encontrada',
  'memberships.value': 'Valor',
  'memberships.academy': 'Academia',
  'memberships.athleteData': 'Datos del Atleta',
  'memberships.fullName': 'Nombre completo',
  'memberships.digitalCard': 'Carnet Digital',
  'memberships.downloadPdf': 'Descargar PDF del Carnet',
  'memberships.manageGradings': 'Gestionar Graduaciones',
  'memberships.gradingHistory': 'Historial de cinturones y promociones',
  ...
  'events.backToEvent': 'Volver al evento',
  'events.until': 'hasta',
  'events.brackets': 'Llaves',
  'events.viewBrackets': 'Ver llaves del torneo',
  'events.noBracketsPublished': 'Llaves aún no publicadas',
  'events.noBracketsPublishedDesc': 'Las llaves estarán disponibles una vez que la organización las publique.',
  ...
  'auth.magicLink.invalidTenant': 'Organización no encontrada o inactiva.',
  ...
  'billing.setup.description': 'Su organización está en fase de configuración. Cuando esté listo, active su suscripción para desbloquear todas las funcionalidades.',
  'billing.setup.cta': 'Iniciar Suscripción',
  'billing.setup.bannerTitle': 'Suscripción aún no iniciada',
  'billing.setup.bannerDescription': 'Configure su suscripción cuando esté listo. Mientras tanto, continúe organizando su institución.',
  ...
  'impersonation.sessionExpiringSoon': 'La sesión de impersonación expira en 5 minutos',
  'impersonation.scopeMismatch': 'Inconsistencia de alcance de impersonación',
  'impersonation.scopeMismatchDesc': 'La sesión de impersonación activa es para un tenant diferente al que intenta acceder.',
  'impersonation.scopeMismatchHint': 'Finalice la sesión actual e inicie una nueva para el tenant correcto.',
  ...
  'onboarding.checklist.title': 'Checklist de Activación',
  'onboarding.checklist.subtitle': 'Complete todos los ítems para activar su organización',
  'onboarding.checklist.statusDone': 'Completado',
  'onboarding.checklist.statusPending': 'Pendiente',
  'onboarding.checklist.statusLocked': 'Bloqueado',
  'onboarding.checklist.tenantCreated': 'Organización creada',
  'onboarding.checklist.tenantCreatedDesc': 'Su organización fue registrada y está activa.',
  'onboarding.checklist.roleAssigned': 'Rol asignado',
  'onboarding.checklist.roleAssignedDesc': 'Su rol administrativo fue configurado.',
  'onboarding.checklist.membershipConfigured': 'Afiliación configurada',
  'onboarding.checklist.membershipConfiguredDesc': 'Al menos una afiliación fue creada.',
  'onboarding.checklist.firstMemberApproved': 'Primer miembro aprobado',
  'onboarding.checklist.firstMemberApprovedDesc': 'Al menos un miembro fue aprobado.',
  'onboarding.checklist.billingActive': 'Facturación activa',
  'onboarding.checklist.billingActiveDesc': 'La facturación fue configurada y está activa.',
  'onboarding.checklist.securityOk': 'Seguridad OK',
  'onboarding.checklist.securityOkDesc': 'La postura de seguridad es saludable.',
  // Role Management
  ...
  // Terms of Use — public legal page (/terms)
  'terms.title': 'Términos de Uso',
  'terms.acceptance.title': '1. Aceptación de los Términos',
  'terms.acceptance.text': 'Al acceder o utilizar Tatame Pro (la "Plataforma"), usted declara haber leído, comprendido y aceptado íntegramente estos Términos de Uso y la Política de Privacidad. Si no está de acuerdo con alguna disposición, debe interrumpir de inmediato el uso de la Plataforma.',
  'terms.service.title': '2. Descripción del Servicio',
  'terms.service.text': 'Tatame Pro es una plataforma SaaS multi-tenant de gestión para federaciones, ligas, academias y organizaciones deportivas de artes marciales. Ofrece registro de atletas, control de afiliaciones, emisión de credenciales digitales y diplomas, gestión de eventos y brackets, rankings, procesamiento de pagos vía Stripe y trazas de auditoría.',
  'terms.account.title': '3. Registro y Cuenta',
  'terms.account.text': 'Para utilizar la Plataforma usted debe:\n- Ser mayor de 18 años o contar con consentimiento expreso del responsable legal\n- Proporcionar información verdadera, completa y actualizada\n- Mantener la confidencialidad de sus credenciales de acceso\n- Notificar de inmediato cualquier uso no autorizado de su cuenta\n\nUsted es el único responsable por todas las actividades realizadas en su cuenta.',
  'terms.acceptableUse.title': '4. Uso Aceptable',
  'terms.acceptableUse.text': 'Usted acepta NO utilizar la Plataforma para:\n- Realizar actividades ilícitas o contrarias a la legislación aplicable\n- Vulnerar derechos de terceros, incluida la propiedad intelectual\n- Insertar datos falsos, engañosos o difamatorios\n- Intentar acceder a áreas restringidas, sistemas de terceros o datos de otros tenants\n- Realizar ingeniería inversa, scraping masivo o ataques de cualquier naturaleza\n- Sobrecargar la infraestructura o interferir en el funcionamiento normal del servicio',
  'terms.payments.title': '5. Pagos y Suscripciones',
  'terms.payments.text': 'Los pagos son procesados exclusivamente por Stripe en cumplimiento con PCI-DSS. Tatame Pro no almacena datos de tarjetas de crédito. Las suscripciones se renuevan automáticamente y pueden cancelarse en cualquier momento desde el portal del cliente, con efecto al final del ciclo de facturación vigente. Los precios pueden ajustarse anualmente con aviso previo de 30 días.',
  'terms.marketplace.title': '6. Marketplace y Transferencias',
  'terms.marketplace.text': 'Tatame Pro opera como facilitador de pagos (marketplace) mediante Stripe Connect. Las cuotas de afiliación e inscripciones a eventos pertenecen a la organización deportiva (Tenant), no a Tatame Pro. Cuando la organización completa el registro en Stripe Connect, los importes son procesados por Stripe y transferidos directamente a la cuenta conectada de la organización, reteniéndose automáticamente solo la tarifa de plataforma divulgada (un porcentaje sobre cada transacción). Tatame Pro no retiene, custodia ni administra los fondos de los atletas más allá de su tarifa. Las transferencias a la cuenta bancaria de la organización siguen el calendario y las reglas de Stripe. Cada organización es responsable de sus obligaciones fiscales sobre los importes recibidos. Hasta que la organización complete el registro en Stripe Connect, los nuevos pagos podrán retenerse temporalmente.',
  'terms.refunds.title': '7. Reembolsos',
  'terms.refunds.text': 'Conforme al Código de Defensa del Consumidor (Art. 49), el usuario persona física tiene derecho al desistimiento dentro de 7 días corridos desde la contratación, con reembolso íntegro. Pasado ese plazo, los reembolsos se evaluarán caso por caso considerando el uso efectivo de la Plataforma. Las cuotas de afiliación pagadas a organizaciones terceras siguen la política de cada organización.',
  'terms.intellectualProperty.title': '8. Propiedad Intelectual',
  'terms.intellectualProperty.text': 'Todo el contenido, marca, código fuente, diseño visual y funcionalidades de la Plataforma son propiedad exclusiva de Tatame Pro o de sus licenciantes, protegidos por las leyes de propiedad intelectual. Se otorga al usuario una licencia limitada, no exclusiva y revocable de uso, restringida a la finalidad contratada.',
  'terms.tenantData.title': '9. Datos del Tenant y Multi-tenancy',
  'terms.tenantData.text': 'Cada federación, liga o academia ("Tenant") es la controladora de los datos de sus afiliados, conforme a la LGPD. Tatame Pro actúa como operador, garantizando el aislamiento técnico entre tenants mediante Row Level Security en la base de datos. El Tenant es responsable de:\n- Obtener las bases legales necesarias para el tratamiento de los datos de sus afiliados\n- Atender las solicitudes de los titulares de datos\n- Mantener un contrato de DPA (Data Processing Agreement) cuando corresponda',
  'terms.availability.title': '10. Disponibilidad del Servicio',
  'terms.availability.text': 'Tatame Pro busca mantener un SLA del 99,5% de disponibilidad mensual, según se describe en nuestra política de SLA. No existe garantía de operación ininterrumpida — las interrupciones programadas se comunicarán con antelación siempre que sea posible. Los mantenimientos de emergencia pueden producirse sin aviso previo.',
  'terms.liability.title': '11. Limitación de Responsabilidad',
  'terms.liability.text': 'Tatame Pro no se responsabiliza por:\n- Contenidos, decisiones o actos practicados por los Tenants o sus afiliados\n- Disputas entre Tenants y sus afiliados\n- Pérdidas derivadas del uso indebido de credenciales por terceros\n- Indisponibilidad temporal de servicios de infraestructura de terceros (Supabase, Stripe, Resend, Cloudflare)\n\nEn los límites permitidos por la ley, la responsabilidad de Tatame Pro queda limitada al monto efectivamente pagado por el usuario en los 12 meses anteriores al hecho que origina la demanda.',
  'terms.termination.title': '12. Suspensión y Terminación',
  'terms.termination.text': 'Tatame Pro se reserva el derecho de suspender o cancelar cuentas que infrinjan estos Términos, con notificación previa cuando sea posible. En caso de infracción grave (fraude, uso ilícito, ataques), la suspensión puede ser inmediata. Tras la terminación, los datos se conservarán por el plazo legal mínimo y luego se eliminarán conforme a la Política de Retención de Datos.',
  'terms.changes.title': '13. Modificaciones de los Términos',
  'terms.changes.text': 'Estos Términos pueden actualizarse periódicamente. Los cambios sustanciales se comunicarán por correo electrónico y/o aviso destacado en la Plataforma con un mínimo de 15 días de antelación. El uso continuado tras la entrada en vigor constituye aceptación tácita.',
  'terms.law.title': '14. Legislación Aplicable y Foro',
  'terms.law.text': 'Estos Términos se rigen por las leyes de la República Federativa del Brasil. Se elige el fuero del domicilio de Tatame Pro para dirimir cualquier controversia, con renuncia a cualquier otro, por privilegiado que fuera.',
  'terms.contact.title': '15. Contacto',
  'terms.contact.text': 'Dudas, solicitudes o notificaciones relacionadas con estos Términos pueden dirigirse al canal de soporte de la Plataforma o a la organización deportiva a la que esté afiliado.',
  'terms.relatedPrivacy': 'Consulte también nuestra',
  'terms.relatedPrivacyLink': 'Política de Privacidad',
  'terms.lastUpdated': 'Última actualización: Mayo de 2026',

  // Footer / shared legal links
  'footer.privacy': 'Privacidad',
  'footer.terms': 'Términos de Uso',
  'checkout.legal.consent': 'Al continuar, usted acepta nuestros',
  'checkout.legal.and': 'y',

  // Stripe Connect — marketplace payouts (settings + banners)
  'connect.title': 'Transferencias y cuenta bancaria',
  'connect.description': 'Conecte su cuenta para recibir las afiliaciones e inscripciones directamente. La plataforma retiene {fee}% por transacción; el resto va a su cuenta automáticamente.',
  'connect.connect': 'Conectar cuenta bancaria',
  'connect.continue': 'Continuar configuración',
  'connect.refresh': 'Actualizar estado',
  'connect.refreshed': 'Estado actualizado.',
  'connect.openDashboard': 'Abrir panel de transferencias',
  'connect.status.active': 'Cuenta activa',
  'connect.status.payoutsOn': 'Las transferencias a su banco están habilitadas.',
  'connect.status.payoutsPending': 'Recibiendo pagos. Las transferencias al banco se liberarán tras la verificación de Stripe.',
  'connect.status.underReview': 'En revisión por Stripe',
  'connect.status.underReviewDesc': 'Completó el registro. Stripe está verificando los datos — suele tardar unos minutos.',
  'connect.status.incomplete': 'Registro iniciado pero no concluido. Continúe para poder recibir pagos.',
  'connect.status.notConnected': 'Aún no ha conectado una cuenta bancaria. Hasta que lo haga, los pagos no llegan a usted.',
  'connect.error.start': 'No se pudo iniciar la conexión. Inténtelo de nuevo.',
  'connect.error.redirect': 'No se pudo abrir la página de registro de Stripe.',
  'connect.error.dashboard': 'No se pudo abrir el panel de transferencias.',
  'connect.banner.notConnected': 'Su organización aún no ha conectado una cuenta bancaria — los pagos quedarán retenidos en la plataforma hasta conectarla.',
  'connect.banner.incomplete': 'El registro de su cuenta bancaria está incompleto — los pagos quedarán retenidos hasta finalizar.',
  'connect.banner.cta': 'Configurar transferencias',

  // ErrorBoundary — global fallback UI for uncaught render errors
  'errorBoundary.title': 'Algo salió mal',
  'errorBoundary.description': 'Ocurrió un error inesperado. Intente recargar la página o volver al inicio.',
  'errorBoundary.errorIdLabel': 'Código de error',
  'errorBoundary.retry': 'Intentar de nuevo',
  'errorBoundary.reload': 'Recargar página',
  'errorBoundary.goHome': 'Volver al portal',
