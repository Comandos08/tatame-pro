export const en: Record<string, string> = {
  ...
  'membership.expectation.title': 'What happens after payment',
  'membership.expectation.body': 'Your payment will be confirmed immediately.\nMembership approval occurs within up to 24 business hours.\nYou can track your status in real time.',
  'membership.expectation.security': 'Secure payment via Stripe. No additional charges will be made without your authorization.',
  'membership.selector.reassurance': 'Simple multi-step process. Immediate payment, fast approval.',
  ...
  'membershipSuccess.paymentConfirmed': 'Payment Confirmed',
   'membershipSuccess.oops': 'Confirmation Error',
   'membershipSuccess.pendingConfirmationTitle': 'Confirmation Pending',
   'membershipSuccess.confirmPending': 'Your payment was received. We are verifying.',
   'membershipSuccess.successMessage': 'Your application has been registered and is under review.',
   'membershipSuccess.invalidParams': 'We could not automatically confirm your payment.',
  'membershipSuccess.confirmError': 'Your payment was received. We are verifying.',
  'membershipSuccess.processError': 'Your payment was received. We are verifying.',
  ...
  'membershipSuccess.retryConfirmation': 'Revalidate payment',
  ...
  'memberships.myMemberships': 'My Memberships',
  'memberships.trackStatus': 'Track the status of your memberships at',
  'memberships.newMembership': 'New Membership',
  'memberships.loadError': 'Error loading memberships',
  'memberships.start': 'Start',
  'memberships.validity': 'Valid until',
  'memberships.card': 'Card',
  'memberships.backToList': 'Back to memberships',
  'memberships.notFound': 'Membership not found',
  'memberships.value': 'Amount',
  'memberships.academy': 'Academy',
  'memberships.athleteData': 'Athlete Data',
  'memberships.fullName': 'Full name',
  'memberships.digitalCard': 'Digital Card',
  'memberships.downloadPdf': 'Download Card PDF',
  'memberships.manageGradings': 'Manage Gradings',
  'memberships.gradingHistory': 'Belt history and promotions',
  ...
  'events.until': 'until',
  'events.brackets': 'Brackets',
  'events.viewBrackets': 'View tournament brackets',
  'events.noBracketsPublished': 'Brackets not yet published',
  'events.noBracketsPublishedDesc': 'Brackets will be available once the organization publishes them.',
  ...
  'auth.magicLink.invalidTenant': 'Organization not found or inactive.',
  ...
  'billing.overview.notAvailableDescription': 'Billing will be available after completing setup.',
  ...
  'impersonation.sessionExpiringSoon': 'Impersonation session expires in 5 minutes',
  'impersonation.scopeMismatch': 'Impersonation scope mismatch',
  'impersonation.scopeMismatchDesc': 'The active impersonation session is for a different tenant than the one you are trying to access.',
  'impersonation.scopeMismatchHint': 'End the current session and start a new one for the correct tenant.',
  ...
  'errors.insufficientRole': 'You do not have permission to access this area.',
  'errors.notAuthenticated': 'You must be authenticated to access this area.',
  'errors.impersonationForbidden': 'Impersonation is not allowed in this context.',
  ...
  'impersonation.autoEntryFailedDesc': 'Could not start an impersonation session for this tenant.',
  'impersonation.autoEntryHint': 'Check that the tenant exists and is active, or return to the admin dashboard.',
  'impersonation.autoEntryRequired': 'Impersonation Required',
  'impersonation.autoEntryRequiredDesc': 'You are accessing a tenant as Superadmin. Confirm to start the impersonation session.',
  'impersonation.startForTenant': 'Start Impersonation',
  ...
  'progress.wizardCompleted': 'Setup completed successfully',
  'progress.billingRegularized': 'Payment confirmed. Thank you!',
  'progress.tenantActivated': 'Environment activated and ready to use',
  'progress.firstAccess': 'Welcome! Your access is active',

  // PI U13 — Empty State Authority
  'emptyState.loading.title': 'Loading information',
  'emptyState.loading.description': 'Please wait while we verify your access.',
  'emptyState.tenantBlocked.title': 'Organization unavailable',
  'emptyState.tenantBlocked.description': 'This organization is temporarily inaccessible. Contact the administrator.',
  'emptyState.billingBlocked.title': 'Access restricted due to payment issue',
  'emptyState.billingBlocked.description': 'Resolve the pending payment to restore full access.',
  'emptyState.noPermission.title': 'Access not authorized',
  'emptyState.noPermission.description': 'You do not have permission to view this content.',
  'emptyState.featureDisabled.title': 'Feature not available',
  'emptyState.featureDisabled.description': 'This feature is not enabled for your organization.',
  ...
  'terms.acceptance.text': 'By accessing or using Tatame Pro (the "Platform"), you acknowledge that you have read, understood and fully agreed to these Terms of Use and to the Privacy Policy. If you do not agree with any provision, you must stop using the Platform immediately.',
  'terms.service.title': '2. Service Description',
  'terms.service.text': 'Tatame Pro is a multi-tenant SaaS platform for federations, leagues, academies and martial-arts organizations. It provides athlete registration, membership management, digital cards and diplomas, event and bracket management, rankings, Stripe-processed payments and audit trails.',
  'terms.account.title': '3. Account Registration',
  'terms.account.text': 'To use the Platform you must:\n- Be 18 years old or older, or have express consent from a legal guardian\n- Provide truthful, complete and up-to-date information\n- Keep your access credentials confidential\n- Promptly notify us of any unauthorized use of your account\n\nYou are solely responsible for all activity performed under your account.',
  'terms.acceptableUse.title': '4. Acceptable Use',
  'terms.acceptableUse.text': 'You agree NOT to use the Platform to:\n- Engage in any unlawful activity\n- Violate third-party rights, including intellectual property\n- Submit false, misleading or defamatory data\n- Attempt to access restricted areas, third-party systems or other tenants’ data\n- Perform reverse engineering, mass scraping or attacks of any kind\n- Overload the infrastructure or interfere with normal service operation',
  'terms.payments.title': '5. Payments and Subscriptions',
  'terms.payments.text': 'Payments are processed exclusively by Stripe in compliance with PCI-DSS. Tatame Pro does not store credit-card data. Subscriptions renew automatically and can be cancelled at any time via the customer portal, taking effect at the end of the current billing cycle. Prices may be adjusted annually with 30 days’ prior notice.',
  'terms.marketplace.title': '6. Marketplace & Payouts',
  'terms.marketplace.text': 'Tatame Pro operates as a payment facilitator (marketplace) via Stripe Connect. Membership and event-registration fees belong to the sports organization (Tenant), not to Tatame Pro. Once the organization completes Stripe Connect onboarding, funds are processed by Stripe and transferred directly to the organization’s connected account, with only the disclosed platform fee (a percentage of each transaction) retained automatically. Tatame Pro does not hold, custody or manage athletes’ funds beyond its fee. Payouts to the organization’s bank account follow Stripe’s schedule and rules. Each organization is responsible for its own tax obligations on amounts received. Until the organization completes Stripe Connect onboarding, new payments may be temporarily held until it does.',
  'terms.refunds.title': '7. Refunds',
  'terms.refunds.text': 'In line with the Brazilian Consumer Protection Code (Art. 49), individual consumers have the right to withdraw within 7 calendar days of contracting, with a full refund. After that period, refunds are reviewed case-by-case considering actual Platform usage. Membership fees paid to third-party organizations follow the policy of the respective organization.',
  'terms.intellectualProperty.title': '8. Intellectual Property',
  'terms.intellectualProperty.text': 'All content, brand, source code, design, layout and features of the Platform are the exclusive property of Tatame Pro or its licensors, protected by intellectual property laws. Users are granted a limited, non-exclusive and revocable license restricted to the contracted purpose.',
  'terms.tenantData.title': '9. Tenant Data and Multi-tenancy',
  'terms.tenantData.text': 'Each federation, league or academy ("Tenant") is the controller of its members’ data under LGPD. Tatame Pro acts as the operator, ensuring technical isolation between tenants via Row Level Security in the database. The Tenant is responsible for:\n- Obtaining the legal bases needed to process its members’ data\n- Fulfilling data-subject requests\n- Maintaining a DPA (Data Processing Agreement) when applicable',
  'terms.availability.title': '10. Service Availability',
  'terms.availability.text': 'Tatame Pro targets 99.5% monthly availability per our SLA. We do not guarantee uninterrupted operation — scheduled downtime will be announced in advance whenever possible. Emergency maintenance may occur without prior notice.',
  'terms.liability.title': '11. Limitation of Liability',
  'terms.liability.text': 'Tatame Pro is not liable for:\n- Content, decisions or actions taken by Tenants or their members\n- Disputes between Tenants and their members\n- Losses arising from third-party misuse of credentials\n- Temporary unavailability of third-party infrastructure (Supabase, Stripe, Resend, Cloudflare)\n\nTo the maximum extent permitted by law, Tatame Pro’s liability is capped at the amount actually paid by the user in the 12 months preceding the event giving rise to the claim.',
  'terms.termination.title': '12. Suspension and Termination',
  'terms.termination.text': 'Tatame Pro reserves the right to suspend or terminate accounts that violate these Terms, with prior notice when possible. For serious violations (fraud, illegal use, attacks), suspension may be immediate. After termination, data will be retained for the minimum legally required period and then deleted in accordance with the Data Retention Policy.',
  'terms.changes.title': '13. Changes to the Terms',
  'terms.changes.text': 'These Terms may be updated periodically. Material changes will be communicated by email and/or a prominent notice on the Platform with at least 15 days’ advance notice. Continued use after the effective date constitutes implicit acceptance.',
  'terms.law.title': '14. Governing Law and Venue',
  'terms.law.text': 'These Terms are governed by the laws of the Federative Republic of Brazil. The courts of the venue where Tatame Pro is headquartered shall have exclusive jurisdiction to resolve any disputes, waiving any other, however privileged.',
  'terms.contact.title': '15. Contact',
  'terms.contact.text': 'Questions, requests or notices regarding these Terms can be sent to the Platform support channel or to the sports organization you are affiliated with.',
  'terms.relatedPrivacy': 'See also our',
  'terms.relatedPrivacyLink': 'Privacy Policy',
  'terms.lastUpdated': 'Last updated: May 2026',

  // Footer / shared legal links
  'footer.privacy': 'Privacy',
  'footer.terms': 'Terms of Use',
  'checkout.legal.consent': 'By proceeding, you agree to our',
  'checkout.legal.and': 'and',

  // Stripe Connect — marketplace payouts (settings + banners)
  'connect.title': 'Payouts & bank account',
  'connect.description': 'Connect your account to receive memberships and registrations directly. The platform keeps {fee}% per transaction; the rest goes to your account automatically.',
  'connect.connect': 'Connect bank account',
  'connect.continue': 'Continue setup',
  'connect.refresh': 'Refresh status',
  'connect.refreshed': 'Status updated.',
  'connect.openDashboard': 'Open payouts dashboard',
  'connect.status.active': 'Account active',
  'connect.status.payoutsOn': 'Payouts to your bank are enabled.',
  'connect.status.payoutsPending': 'Accepting payments. Bank payouts will be released after Stripe verification.',
  'connect.status.underReview': 'Under review by Stripe',
  'connect.status.underReviewDesc': 'You completed the form. Stripe is verifying the details — this usually takes a few minutes.',
  'connect.status.incomplete': 'Setup started but not finished. Continue to start receiving payments.',
  'connect.status.notConnected': 'You have not connected a bank account yet. Until you do, payments will not reach you.',
  'connect.error.start': 'Could not start the connection. Please try again.',
  'connect.error.redirect': 'Could not open the Stripe onboarding page.',
  'connect.error.dashboard': 'Could not open the payouts dashboard.',
  'connect.banner.notConnected': 'Your organization has not connected a bank account yet — payments will be held by the platform until you connect.',
  'connect.banner.incomplete': 'Your bank account setup is incomplete — payments will be held until you finish.',
  'connect.banner.cta': 'Set up payouts',
