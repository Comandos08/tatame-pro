export const en: Record<string, string> = {
  ...
  'about.heroSubtitle': 'A layer of governance, registration and traceability for the sports ecosystem.',
  'about.role.title': 'The role of Tatame in sport',
  'about.role.text': 'Tatame is a digital infrastructure designed to provide institutional support to the combat sports ecosystem. Its role is structural: organizing records, preserving histories and enabling reliable governance across different layers of sport.\n\nTatame does not replace existing entities or interfere with their decisions. It acts as a neutral foundation that strengthens federations, organizations and professionals by offering a consistent, verifiable and long-term institutional environment.',
  'about.limits.title': 'What Tatame does not do',
  'about.limits.text': 'Tatame is not a federation, confederation or sports league. It does not compete with existing entities, does not centralize institutional power and does not act as a regulatory body.\n\nTatame also does not issue gradings, certifications or sports decisions on its own. All validations, registrations and recognitions respect the autonomy of the responsible organizations, functioning as institutional support — never as a replacement.',
  'about.ecosystem.title': 'Ecosystem structure',
  'about.ecosystem.text': 'Tatame was designed to reflect the real structure of sport, respecting its layers and responsibilities.',
  ...
  'about.ecosystem.layer3': 'Individuals — athletes, coaches, referees and other professionals who build their sports careers.',
  ...
  'about.governance.text': 'Records made in Tatame follow institutional principles of organization, traceability and public verification. Histories are preserved, relevant events are auditable and information can be validated transparently.\n\nThis model strengthens the credibility of the sports ecosystem, reduces ambiguities and contributes to the historical preservation of sports trajectories, always respecting the institutional limits of each entity.',
  'about.neutrality.title': 'Neutrality and continuity',
  'about.neutrality.text': 'Tatame was conceived as a neutral infrastructure, independent of people, administrations or administrative cycles. Its commitment is to institutional continuity, historical preservation and collaboration between organizations.\n\nBy not assuming a political, competitive or regulatory role, Tatame creates a stable environment for institutional cooperation and sustainable evolution of sport over time.',
  'about.cta': 'Explore the institutional infrastructure',
